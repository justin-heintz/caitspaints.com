...
add_custom_image_header( 'quintus_header_style', 'quintus_admin_header_style', 'quintus_admin_header_image' );
...
/**
 * Markup for the header image displayed on the Appearance > Header admin panel.
 */
