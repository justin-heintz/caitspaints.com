...
?>
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				<h2 class="entry-title"><span><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'retro-mac-os' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a></span></h2>
				<small>
				...
				<?php if ( is_multi_author() ) : ?>
					<?php
						printf( __( 'by <span class="author vcard"><a class="url fn n" href="%1$s" title="%2$s">%3$s</a></span>', 'retro' ),
							...
							esc_attr( sprintf( __( 'View all posts by %s', 'retro' ), get_the_author() ) ),
							get_the_author()
						);
					?>
				<?php endif; ?>
