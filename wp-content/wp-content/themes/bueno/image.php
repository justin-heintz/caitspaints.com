                    ...
                    <div class="post-meta">
                    	...
                    	<ul <?php if ( ! is_multi_author() ) echo 'class="single-author-image-meta"';?>>
							...
							<li class="parent">
								...
								<span class="body"><a href="<?php echo get_permalink( $post->post_parent ); ?>" title="<?php echo esc_attr( sprintf( __( 'Return to %s', 'woothemes' ), strip_tags( get_the_title( $post->post_parent ) ) ) ); ?>" rel="gallery"><?php echo get_the_title( $post->post_parent ); ?></a>
								</span>
							</li>
							<li class="imagelink">
