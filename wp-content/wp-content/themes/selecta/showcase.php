	...
	<div class="feature-slider">
		...
		<?php
			...
			<li id="featured-<?php echo $counter_slider; ?>">
				<a href="#featured-post-<?php echo $counter_slider; ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'selecta' ), the_title_attribute( 'echo=0' ) ) ); ?>" class="post-link"><span><?php echo $counter_slider; ?></span></a>
