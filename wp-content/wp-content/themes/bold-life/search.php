...
<div class="post-wrapper">
	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class( 'wide-entry-wrapper' ); ?>>
			...
			<?php // Only show dates on posts, not pages ?>
			<?php if ( 'post' == get_post_type() ) { ?>
				<div class="post-date-wrapper">
					<div class="post-date">
						<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'bold-life' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark">
			...
			?>
				<div class="entry">
					<div class="entry-inner">
						<h2 class="post-title">
							<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'bold-life' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a>
						</h2>
						<?php
