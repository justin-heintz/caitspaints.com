...
<div id="footer">
	...
	<div class="cell cell-2">
		...
		?>
		<div class="widget">
			<h2><?php _e( 'Calendar', 'uti_theme' ); ?></h2>
			<div class="line"></div>
			<div>
				<?php get_calendar(); ?>
			</div>
	...
	<div class="cell cell-3">
		...
		?>
		<div class="widget">
			<h2><?php _e( 'Archives', 'uti_theme' ); ?></h2>
			<div class="line"></div>
			<ul>
	...
	<div class="cell cell-4">
		...
		?>
		<div class="widget">
			<h2><?php _e( 'Blogroll', 'uti_theme' ); ?></h2>
			<div class="line"></div>
			<ul>
	...
	<div id="externalFooterLinks">
		...
		<?php printf( __( 'Theme: %1$s by %2$s.', 'uti_theme' ), 'Under the Influence', '<a href="http://www.spaceperson.net" rel="designer">spaceperson</a>' ); ?>
	</div>
</div><!--#footer-->
</div><!--#page-->
<?php wp_footer(); ?>
