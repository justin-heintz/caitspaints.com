...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="container">
		...
		<header class="entry-header">
			<h1 class="entry-title hitchcock"><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'vertigo' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
		</header><!-- .entry-header -->
