...
<div class="box">
	...
	<?php if ( has_post_thumbnail() ) : //if there is a featured image ?>
		<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'imbalance2' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_post_thumbnail( 'homepage-thumb' ); ?></a>
	<?php endif; ?>
	...
	<?php endif; ?>
		...
		<h1><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'imbalance2' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
