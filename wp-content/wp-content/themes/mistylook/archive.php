		...
		<?php while (have_posts()) : the_post(); ?>
			...
			<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
				<div class="posttitle">
					...
					<p class="post-info">
						<?php printf( __( 'Posted in %s on %s', 'mistylook' ), get_the_category_list( ', ' ).get_the_tag_list( ', '.__( 'tagged', 'mistylook' ).' ', ', ' ), get_the_time( get_option( 'date_format' ) ) ); ?> | <?php edit_post_link( __( 'Edit', 'mistylook' ), '', ' | ' ); ?>
