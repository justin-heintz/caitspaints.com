...
<?php if (have_posts()) : ?>
	...
	<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
		<h6><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'modularity' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_title() ?></a></h6>

		<?php if ( has_post_thumbnail() ) : ?>
			<a href="<?php the_permalink() ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'modularity' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_post_thumbnail(); ?></a>
		<?php endif; ?>
