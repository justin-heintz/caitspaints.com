...
<?php while ( have_posts() ) : the_post(); // Start the loop. ?>
	...
	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<?php } ?>
		<h2 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'adventurejournal' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
