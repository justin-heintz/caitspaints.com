...
<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	<div class="entry">
		<h3 class="result"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'spectrum' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_title(); ?></a></h3>
		<?php if ( ! is_search() ) : ?>
			<?php the_excerpt(); ?>
		<?php endif; ?>
	</div>
