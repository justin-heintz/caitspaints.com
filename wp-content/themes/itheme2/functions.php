...
function itheme2_home_posts( $query = false ) {
	...
	$query->query_vars['post__not_in'] = itheme2_featuring_posts();
 ...
 */
function itheme2_featuring_posts( $force_update = false ) {
...
function itheme2_featured_post_checker_flusher() {
	// Vvwooshh!
	itheme2_featuring_posts( true );
}
add_action( 'update_option_sticky_posts', 'itheme2_featured_post_checker_flusher' );
