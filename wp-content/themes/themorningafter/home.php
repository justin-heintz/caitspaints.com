			...
			<div id="latest_post" <?php post_class(); ?>>
				...
				<div id="latest_post_image">
					<?php if ( has_post_thumbnail() ) { ?>
						<a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'woothemes' ), the_title_attribute( 'echo=0' ) ) ); ?>">
							<?php the_post_thumbnail( array( 470, 'auto' ), array( 'alt' => get_the_title(), 'title' => get_the_title() ) ); ?>
						</a>
					<?php } ?>
				</div>

				<h2 class="latest_post_title" id="post-<?php the_ID(); ?>"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'woothemes' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_title(); ?></a></h2>
			...
			<div id="home_featured" class="clear-fix">
				...
				<?php while ( $sticky_query->have_posts() ) : $sticky_query->the_post(); ?>
					...
					<div class="feat_content clear-fix">
						...
						<div class="feat_title"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'woothemes' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_title(); ?></a></div>
