...
<div id="arch_content" class="column full-width">
	...
	<?php if ( have_posts() ) : ?>
		<?php the_post(); // load the first post so that we have access to user information ?>
		...
		<?php rewind_posts(); // rewind so that we don't miss that first post in the loop ?>
		<div class="column mid-column">
			<?php while ( have_posts() ) : the_post(); ?>
				<div class="archive_post_block clear-fix">
					<h3 class="archive_title" id="post-<?php the_ID(); ?>">
