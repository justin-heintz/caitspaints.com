...
<section id="content" role="main">
	...
	<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					?>
					<figure>
						<?php $attachment_size = apply_filters( 'blaskan_attachment_size', $content_width ); ?>
						<a href="<?php echo $next_attachment_url; ?>" title="<?php echo esc_attr( get_the_title() ); ?>" rel="attachment"><?php echo wp_get_attachment_image( $post->ID, array( $attachment_size, $attachment_size ) ); ?></a>
