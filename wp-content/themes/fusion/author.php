...
?>
	...
	<div class="profile">
		<div class="avatar left"><?php echo get_avatar( get_the_author_meta( 'email', $author_id ), '128' ); ?></div>
		<div class="info">
		<?php
	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<h3 class="title"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'fusion' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_title(); ?></a></h3>
