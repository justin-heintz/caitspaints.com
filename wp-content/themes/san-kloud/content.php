	...
	<div class="post-middle">
		...
		<div class="post-title">
			<?php if ( get_the_title() ): ?>
				...
				<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'san-kloud' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><span class="post-date"><?php echo the_date(); ?></span></a>
			<?php else: ?>
				<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'san-kloud' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><span class="post-date no-title"><?php echo the_date(); ?></span></a>
			<?php endif; ?>
		</div>
