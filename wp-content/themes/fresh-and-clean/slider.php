        ...
        <div class="featured-posts">
                ...
                ?>
                        <section class="featured" id="featured-post-<?php echo $counter_slider; ?>">
                                <a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'fresh-and-clean' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_post_thumbnail( 'large-feature' ); ?></a>
                        ...
                        if ( has_post_thumbnail() ) {
                                ...
                                continue;
                                        ...
                                        if ( 1 == $counter_slider )
                                                ...
                                                $class = '';
                        ?>
                                <li><a href="#featured-post-<?php echo $counter_slider; ?>" title="<?php echo esc_attr( sprintf( __( 'Featuring: %s', 'fresh-and-clean' ), the_title_attribute( 'echo=0' ) ) ); ?>" <?php echo $class; ?>><?php echo $counter_slider; ?></a></li>
                        <?php endwhile; ?>
                        </ul>
                </nav>
