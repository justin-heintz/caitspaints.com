...
<div <?php post_class( 'box entry' ); ?>>
	...
	<h2 class="entry-title">
		<?php if ( ! is_single() ) : ?>
			<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'fauna' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a>
		<?php else : ?>
			<?php the_title(); ?>
		<?php endif; ?>
	</h2>
	...
	<div class="entry-meta">
		...
		<?php /* by <?php the_author_posts_link(); ?> */ ?>
	</div>
	<?php } ?>
