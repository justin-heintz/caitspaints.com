		...
		<div id="comment-<?php comment_ID(); ?>">
			...
			<div class="comment-body">
				<div class="comment-meta commentmetadata">
					...
					<?php printf( __( '%1$s at %2$s', 'yoko' ), get_comment_date(),  get_comment_time() ); ?></a><?php edit_comment_link( __( 'Edit &rarr;', 'yoko' ), ' ' ); ?>
				</div>
...
function yoko_scripts() {
	...
	wp_enqueue_style( 'yoko-fonts', 'http://fonts.googleapis.com/css?family=Droid+Sans:regular,bold|Droid+Serif:regular,italic,bold,bolditalic&subset=latin' );
